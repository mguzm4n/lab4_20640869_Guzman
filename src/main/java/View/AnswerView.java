 ...
 */
public class AnswerView extends javax.swing.JDialog {
    Model.Question question;
    StackController stackController;
    boolean firstFocused;
    /**
     * Creates new form AnsweView
     */
    public AnswerView(javax.swing.JDialog parent, boolean modal, StackController stackController, Model.Question question) {
        super(parent, modal);
        initComponents();
    ...
    private void sendAnswerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendAnswerBtnActionPerformed
       JOptionPane.showMessageDialog(this, "Boton Funciona");
